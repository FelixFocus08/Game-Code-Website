...
import { FaTwitch, FaSteam, FaRedditAlien } from "react-icons/fa";
...
const resources = [
  { name: "Twitch", url: "https://twitch.tv/fel1g0r", description: "Live-Streams und Gaming-Content", icon: <FaTwitch className="h-6 w-6 text-purple-500" />, color: "bg-purple-600/10" },
  ...
  { name: "YouTube Kanäle", internalPath: "/youtube-channels", description: "Videos, Streams und mehr", icon: <Youtube className="h-6 w-6 text-red-600" />, color: "bg-red-600/10" },
];
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {resources.map((resource, index) => {
              ...
              return resource.internalPath ? (
                <Link to={resource.internalPath} {...commonProps}>
                  {content}
                </Link>
              ) : (
                <a 
